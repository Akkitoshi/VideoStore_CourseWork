...
{
    public partial class FormReport3 : MaterialForm
    {
        public FormReport3()
        {
            InitializeComponent();
        ...
        public void LoadData()
        {
            ...
            con.Open();
            string connectionString = "Select Type, FIO , SummaryPrice, DateOfConclusion FROM  ClientContracts, Products, Users";
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (FileStream stream = new FileStream(folderPath + "Заключенные_договора_по_видам_товара.pdf", FileMode.Create))
                {
